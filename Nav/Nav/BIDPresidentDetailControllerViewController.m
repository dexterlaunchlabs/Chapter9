//
//  BIDPresidentDetailControllerViewController.m
//  Nav
//
...
@interface BIDPresidentDetailControllerViewController ()

@end

@implementation BIDPresidentDetailControllerViewController
